...
ImageButton1.Image = "rbxassetid://18915999121";
...
Update.Window = function(self, text, logo, keybind)
	local osfunc = {};
	local uihide = false;
	local abc = false;
	local currentpage = "";
	...
	UserText.Text = "EXPRERADOR-DUONG";
	UserText.TextScaled = true;
	UserText.TextSize = 17;
	...
	UserImage.Image = "rbxassetid://18915999121";
	...
	Logo.Image = "rbxassetid://18915999121";
	...
	local uitab = {};
	uitab.AddTab = function(self, text, img)
		local BtnStroke = Instance.new("UIStroke");
		...
		Update.AddNotification = function(self, textdesc)
			...
			NotificationFrame:TweenSize(UDim2.new(0, 400, 0, 250), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, 0.6, true);
			...
			OkayBtn.MouseEnter:Connect(function()
				TweenService:Create(OkayBtn, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3=Color3.fromRGB(34, 34, 34)}):Play();
			end);
			OkayBtn.MouseLeave:Connect(function()
				TweenService:Create(OkayBtn, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3=Color3.fromRGB(25, 25, 25)}):Play();
			end);
		...
		local main = {};
		main.AddButton = function(self, text, callback)
			if (logo == nil) then
				logo = "15009422255";
			end
			...
			ImageButton.Image = "rbxassetid://18915999121";
		...
		main.AddToggle = function(self, TogInfo, default, callback)
			local toggle = false;
			if (logo == nil) then
				logo = "15009422255";
			end
			...
			ImageLabel.Image = "rbxassetid://18915999121";
			...
			if (default == true) then
				...
				game.TweenService:Create(ImageButton, TweenInfo.new(0.08, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {ImageColor3=Color3.fromRGB(255, 255, 255)}):Play();
				toggle = not toggle;
		...
		main.AddDropdown = function(self, text, option, callback)
		...
		main.AddSlider = function(self, text, min, max, start, callback)
			local sliderfunc = {};
			...
			SliderButton.InputBegan:Connect(function(input)
				if ((input.UserInputType == Enum.UserInputType.MouseButton1) or (input.UserInputType == Enum.UserInputType.Touch)) then
					...
					game.TweenService:Create(Title_2, TweenInfo.new(0.12, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {AnchorPoint=Vector2.new(0.22, 0.8),TextSize=13,BackgroundTransparency=0,Size=UDim2.new(0, 25, 0, 25)}):Play();
			...
			SliderButton.InputEnded:Connect(function(input)
				if ((input.UserInputType == Enum.UserInputType.MouseMovement) or (input.UserInputType == Enum.UserInputType.Touch)) then
					...
					game.TweenService:Create(Title_2, TweenInfo.new(0.12, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {AnchorPoint=Vector2.new(0, 0),TextSize=8,BackgroundTransparency=1,Size=UDim2.new(0, 18, 0, 18)}):Play();
		...
		main.AddTextbox = function(self, text, disappear, callback)
		...
		main.AddLabel = function(self, text)
			...
			labelfunc.Set = function(self, newtext)
				Label.Text = newtext;
			end;
			return labelfunc;
		end;
		main.AddLabel1 = function(self, text)
			...
			Label1func.Refresh = function(self, tochange)
		...
		main.Dis = function(self, text, display)
			local Label1 = Instance.new("TextLabel");
			local PaddingLabel1 = Instance.new("UIPadding");
			local Label1func = {};
			Label1.Name = "Label1";
		...
		main.AddSeperator = function(self, text)
...
function TP(Pos)
	...
	game:GetService("TweenService"):Create(game.Players.LocalPlayer.Character.HumanoidRootPart, TweenInfo.new(Distance / Speed, Enum.EasingStyle.Linear), {CFrame=Pos}):Play();
end
function TP1(Pos)
	Distance = (Pos.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude;
	if (Distance < 25) then
				...
				pcall(function()
					...
					if ((MyLevel >= 700) and World1) then
						if ((game:GetService("Workspace").Map.Ice.Door.CanCollide == false) and (game:GetService("Workspace").Map.Ice.Door.Transparency == 1)) then
							...
							EquipWeapon("Key");
							repeat
								HyperCahaya(CFrame.new(1347.7124, 37.3751602, -1325.6488));
								wait();
						...
						if (game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BartiloQuestProgress", "Bartilo") == 3) then
							if (game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("GetUnlockables").FlamingoAccess ~= nil) then
								...
								elseif (game:GetService("ReplicatedStorage").Remotes['CommF_']:InvokeServer("ZQuestProgress", "Check") == 1) then
									Com("F_", "TravelZou");
								elseif game.Workspace.Enemies:FindFirstChild("Don Swan") then
									for i, v in pairs(game.Workspace.Enemies:GetChildren()) do
									...
									TweenDonSwanthireworld = HyperCahaya(CFrame.new(2288.802, 15.1870775, 863.034607).Position, CFrame.new(2288.802, 15.1870775, 863.034607));
						...
						elseif (game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BartiloQuestProgress", "Bartilo") == 0) then
							if (string.find(game.Players.LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "Swan Pirates") and string.find(game.Players.LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "50") and (game.Players.LocalPlayer.PlayerGui.Main.Quest.Visible == true)) then
								if game.Workspace.Enemies:FindFirstChild("Swan Pirate") then
									...
									Questtween = HyperCahaya(CFrame.new(960.9769897460938, 141.33583068847656, 1216.1959228515625).Position, CFrame.new(960.9769897460938, 141.33583068847656, 1216.1959228515625));
								...
								Bartilotween = HyperCahaya(CFrame.new(-456.28952, 73.0200958, 299.895966).Position, CFrame.new(-456.28952, 73.0200958, 299.895966));
		...
		pcall(function()
			while wait() do
				if game.Workspace._WorldOrigin.Locations:FindFirstChild("Mirage Island") then
					...
					Mirragecheck:Set("âŒ: Mystic Island Not Found ");
				end
			end
		end);
	end);
				...
				if string.find(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySharkmanKarate"), "keys") then
					...
					elseif (game:GetService("Players").LocalPlayer.Character:FindFirstChild("Fishman Karate") and (game:GetService("Players").LocalPlayer.Character:FindFirstChild("Fishman Karate").Level.Value >= 400)) then
						...
						if game:GetService("Workspace").Enemies:FindFirstChild(Ms) then
							...
							HyperCahaya(CFrame.new(-3570.18652, 123.328949, -11555.9072, 0.465199202, -1.3857326e-8, 0.885206044, 4.0332897e-9, 1, 1.3534751e-8, -0.885206044, -2.7260627e-9, 0.465199202));
							wait(3);
						end
					end
				else
			...
			pcall(function()
				if (game.Players.LocalPlayer.Character:FindFirstChild("Superhuman") or game.Players.LocalPlayer.Backpack:FindFirstChild("Superhuman") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Black Leg") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Black Leg") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Death Step") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Death Step") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Fishman Karate") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Fishman Karate") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Sharkman Karate") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Sharkman Karate") or game.Players.LocalPlayer.Backpack:FindFirstChild("Electro") or game.Players.LocalPlayer.Character:FindFirstChild("Electro") or game.Players.LocalPlayer.Backpack:FindFirstChild("Electric Claw") or game.Players.LocalPlayer.Character:FindFirstChild("Electric Claw") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Dragon Claw") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Dragon Claw") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Dragon Talon") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Dragon Talon") or game.Players.LocalPlayer.Character:FindFirstChild("Godhuman") or game.Players.LocalPlayer.Backpack:FindFirstChild("Godhuman")) then
					if (game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySuperhuman", true) == 1) then
						...
						game.StarterGui:SetCore("SendNotification", {Title="Notification",Text="Not Have Superhuman",Icon="http://www.roblox.com/asset/?id=18915999121",Duration=2.5});
					end
					if (game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyDeathStep", true) == 1) then
						...
						game.StarterGui:SetCore("SendNotification", {Title="Notification",Text="Not Have Death Step",Icon="http://www.roblox.com/asset/?id=18915999121",Duration=2.5});
					end
					if (game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySharkmanKarate", true) == 1) then
						...
						game.StarterGui:SetCore("SendNotification", {Title="Notification",Text="Not Have SharkMan Karate",Icon="http://www.roblox.com/asset/?id=18915999121",Duration=2.5});
					end
					if (game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyElectricClaw", true) == 1) then
						...
						game.StarterGui:SetCore("SendNotification", {Title="Notification",Text="Not Have Electric Claw",Icon="http://www.roblox.com/asset/?id=18915999121",Duration=2.5});
					end
					if (game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyDragonTalon", true) == 1) then
						if ((game.Players.LocalPlayer.Backpack:FindFirstChild("Dragon Talon") and (game.Players.LocalPlayer.Backpack:FindFirstChild("Dragon Talon").Level.Value >= 400)) or (game.Players.LocalPlayer.Character:FindFirstChild("Dragon Talon") and (game.Players.LocalPlayer.Character:FindFirstChild("Dragon Talon").Level.Value >= 400))) then
							if string.find(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyGodhuman", true), "Bring") then
								game.StarterGui:SetCore("SendNotification", {Title="Notification",Text="Not Have Enough Material",Icon="http://www.roblox.com/asset/?id=18915999121",Duration=2.5});
							else
								game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyGodhuman");
							end
						end
					else
						game.StarterGui:SetCore("SendNotification", {Title="Notification",Text="Not Have Dragon Talon",Icon="http://www.roblox.com/asset/?id=18915999121",Duration=2.5});
					end
				else
					game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySuperhuman");
				end
...
M:AddToggle("Auto Get Anchor [ Need Material ]", _G.BjirAnchorCuy, function(state)
	...
	elseif (state and findItem("Terror Eyes", 2) and findItem("Electric Wing", 8) and findItem("Fool's Gold", 20) and findItem("Shark Tooth", 10)) then
		local args = {[1]="CraftItem",[2]="Check",[3]="SharkAnchor"};
		game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args));
		local args = {[1]="CraftItem",[2]="Craft",[3]="SharkAnchor"};
		game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args));
		wait(0.5);
		_G.BjirAnchorCuy = true;
	elseif (state and (not findItem("Monster Magnet", 1) or (not findItem("Terror Eyes", 2) and not findItem("Electric Wing", 8) and not findItem("Fool's Gold", 20) and not findItem("Shark Tooth", 10)))) then
		...
		game.StarterGui:SetCore("SendNotification", {Icon="rbxassetid://14601663040",Title="! WARNING !",Text="You need more materials \nto buy a Monster Magnet."});
	else
		_G.BjirAnchorCuy = false;
	end
	...
	while wait() do
		pcall(function()
			if _G.BjirAnchorCuy then
				...
				local enemyTypes = {{name="Terrorshark",variable="bjirTerrorshark"},{name="Shark",variable="bjirShark"},{name="Piranha",variable="bjirPiranha"},{name="FishBoat",variable="bjirFishBoat"}};
				for _, v in next, workspace.Boats.PirateBrigade:GetDescendants() do
					if v.Name:find("VehicleSeat") then
						vehicleSeat = v;
						wait(0.2);
					...
					if ((CFrame.new(-9681.458984375, 6.139880657196045, 6341.3720703125).Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 5000) then
						...
						elseif (game:GetService("Workspace").Map["Haunted Castle"].Candle1.Transparency == 0) then
							if (game:GetService("Workspace").Map["Haunted Castle"].Placard1.Left.Part.Transparency == 0) then
								...
								repeat
									wait();
									HyperCahaya(CFrame.new(-8762.69140625, 176.84783935546875, 6171.3076171875));
							...
							elseif game:GetService("Workspace").Map["Haunted Castle"].Tablet.Segment1:FindFirstChild("ClickDetector") then
								if game:GetService("Workspace").Map["Haunted Castle"]["Lab Puzzle"].ColorFloor.Model.Part1:FindFirstChild("ClickDetector") then
									...
									repeat
										wait();
										HyperCahaya(CFrame.new(-9553.5986328125, 65.62338256835938, 6041.58837890625));
...
spawn(function()
	while wait() do
		if _G.AutoRaidPirate then
			pcall(function()
				local CFrameBoss = CFrame.new(-5496.17432, 313.768921, -2841.53027, 0.924894512, 7.37058e-9, 0.380223751, 3.588102e-8, 1, -1.06665446e-7, -0.380223751, 1.1229711e-7, 0.924894512);
				if ((CFrame.new(-5539.3115234375, 313.800537109375, -2972.372314453125).Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 500) then
					for i, v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
		...
		if _G.AutoFarmBossHallow then
			pcall(function()
				...
				elseif (game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Hallow Essence") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Hallow Essence")) then
					repeat
						HyperCahaya(CFrame.new(-8932.322265625, 146.83154296875, 6062.55078125));
						wait();
...
M:AddToggle("Spawn Rip Indra [ NEED CHALICE ]", false, function()
	AutoHaki();
	wait(0.5);
	local args = {[1]="activateColor",[2]="Snow White"};
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args));
	wait(0.5);
	AutoHaki();
	wait(0.1);
	...
	AutoHaki();
	wait(0.5);
	local args = {[1]="activateColor",[2]="Pure Red"};
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args));
	wait(0.5);
	AutoHaki();
	wait(0.1);
	...
	AutoHaki();
	wait(0.5);
	local args = {[1]="activateColor",[2]="Winter Sky"};
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args));
	wait(0.5);
	AutoHaki();
	wait(0.1);
		...
		while wait() do
			if _G.AutoObservation then
				if (game:GetService("Players").LocalPlayer.VisionRadius.Value >= 3000) then
					game:GetService("StarterGui"):SetCore("SendNotification", {Icon="rbxassetid://0",Title="Status Observation",Text="You Have Max Points"});
					wait(2);
				elseif World2 then
					if game:GetService("Workspace").Enemies:FindFirstChild("Lava Pirate") then
...
spawn(function()
	while wait() do
		if _G.AutoSaber then
			...
			elseif (game.Workspace.Map.Jungle.Final.Part.CanCollide == false) then
			...
			elseif (Workspace.Map.Jungle.QuestPlates.Door.CanCollide == false) then
				if (game.Workspace.Map.Desert.Burn.Part.CanCollide == false) then
					...
					elseif (game.Players.LocalPlayer.Backpack:FindFirstChild("Cup") or game.Players.LocalPlayer.Character:FindFirstChild("Cup")) then
						EquipWeapon("Cup");
				...
				elseif (game.Players.LocalPlayer.Backpack:FindFirstChild("Torch") or game.Players.LocalPlayer.Character:FindFirstChild("Torch")) then
					EquipWeapon("Torch");
			...
			if _G.Auto_Rainbow_Haki then
				...
				elseif ((game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true) and string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "Stone")) then
					if game:GetService("Workspace").Enemies:FindFirstChild("Stone") then
						...
						HyperCahaya(CFrame.new(-1086.11621, 38.8425903, 6768.71436, 0.0231462717, -0.592676699, 0.805107772, 0.000020325184, 0.805323839, 0.592835128, -0.999732077, -0.0137055516, 0.0186523199));
					end
				...
				elseif string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "Captain Elephant") then
					if game:GetService("Workspace").Enemies:FindFirstChild("Captain Elephant") then
						...
						HyperCahaya(CFrame.new(-13485.0283, 331.709259, -8012.4873, 0.714521289, 7.988499e-8, 0.69961375, -1.0206575e-7, 1, -9.943831e-9, -0.69961375, -6.4301524e-8, 0.714521289));
					end
			...
			if _G.Auto_EvoRace then
				if not game:GetService("Players").LocalPlayer.Data.Race:FindFirstChild("Evolved") then
					if (game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Alchemist", "1") == 0) then
						HyperCahaya(CFrame.new(-2779.83521, 72.9661407, -3574.02002, -0.730484903, 6.390141e-8, -0.68292886, 3.5996322e-8, 1, 5.5066703e-8, 0.68292886, 1.5642467e-8, -0.730484903));
			...
			if _G.AutoBartilo then
				if ((game:GetService("Players").LocalPlayer.Data.Level.Value >= 800) and (game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BartiloQuestProgress", "Bartilo") == 0)) then
					if (string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "Swan Pirates") and string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "50") and (game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true)) then
						if game:GetService("Workspace").Enemies:FindFirstChild("Swan Pirate") then
							...
							repeat
								HyperCahaya(CFrame.new(932.624451, 156.106079, 1180.27466, -0.973085582, 4.5513712e-8, -0.230443969, 2.6702471e-8, 1, 8.474911e-8, 0.230443969, 7.631471e-8, -0.973085582));
								wait();
						...
						repeat
							HyperCahaya(CFrame.new(-456.28952, 73.0200958, 299.895966));
							wait();
				...
				elseif ((game:GetService("Players").LocalPlayer.Data.Level.Value >= 800) and (game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BartiloQuestProgress", "Bartilo") == 1)) then
					...
					elseif game:GetService("ReplicatedStorage"):FindFirstChild("Jeremy") then
						...
						wait(1);
						repeat
							HyperCahaya(CFrame.new(2099.88159, 448.931, 648.997375));
							wait();
				...
				elseif ((game:GetService("Players").LocalPlayer.Data.Level.Value >= 800) and (game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BartiloQuestProgress", "Bartilo") == 2)) then
					repeat
						HyperCahaya(CFrame.new(-1850.49329, 13.1789551, 1750.89685));
						wait();
					...
					wait(1);
					repeat
						HyperCahaya(CFrame.new(-1858.87305, 19.3777466, 1712.01807));
						wait();
					...
					wait(1);
					repeat
						HyperCahaya(CFrame.new(-1803.94324, 16.5789185, 1750.89685));
						wait();
					...
					wait(1);
					repeat
						HyperCahaya(CFrame.new(-1858.55835, 16.8604317, 1724.79541));
						wait();
					...
					wait(1);
					repeat
						HyperCahaya(CFrame.new(-1869.54224, 15.987854, 1681.00659));
						wait();
					...
					wait(1);
					repeat
						HyperCahaya(CFrame.new(-1800.0979, 16.4978027, 1684.52368));
						wait();
					...
					wait(1);
					repeat
						HyperCahaya(CFrame.new(-1819.26343, 14.795166, 1717.90625));
						wait();
					...
					wait(1);
					repeat
						HyperCahaya(CFrame.new(-1813.51843, 14.8604736, 1724.79541));
						wait();
	...
	while wait() do
		pcall(function()
			if _G.Auto_Stats_Kaitun then
				if World1 then
					local args = {[1]="AddPoint",[2]="Melee",[3]=_G.Point};
					game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args));
				elseif World2 then
					local args = {[1]="AddPoint",[2]="Melee",[3]=_G.Point};
					game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args));
					local args = {[1]="AddPoint",[2]="Defense",[3]=_G.Point};
					game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args));
				end
			end
		end);
...
P:AddToggle("Teleport", false, function(value)
	...
	pcall(function()
		if _G.TeleportPly then
			repeat
				HyperCahaya(game:GetService("Players")[_G.SelectPly].Character.HumanoidRootPart.CFrame);
				wait();
	...
	while task.wait() do
		if (_G.Aimbot_Gun and game:GetService("Players").LocalPlayer.Character:FindFirstChild(SelectWeaponGun)) then
			pcall(function()
				...
				local args = {[1]=game:GetService("Players"):FindFirstChild(PlayerSelectAimbot).Character.HumanoidRootPart.Position,[2]=game:GetService("Players"):FindFirstChild(PlayerSelectAimbot).Character.HumanoidRootPart};
				game:GetService("Players").LocalPlayer.Character[SelectWeaponGun].RemoteFunctionShoot:InvokeServer(unpack(args));
				game:GetService("VirtualUser"):CaptureController();
				game:GetService("VirtualUser"):Button1Down(Vector2.new(1280, 672));
			end);
...
P:AddToggle("Aimbot Skill", false, function(value)
    _G.Aimbot_Skill = value;  -- Bật hoặc tắt Aimbot
end);

local AimbotRunning = false  -- Cờ kiểm tra trạng thái aimbot

-- Hàm Aimbot từ mã 2 được thay thế
local function StartAimbot()
    if AimbotRunning then return end  -- Tránh việc chạy lại nếu aimbot đã được bật
    AimbotRunning = true

    spawn(function()
        pcall(function()
            while task.wait() and _G.Aimbot_Skill do  -- Chạy nếu toggle Aimbot bật
                local AimBotPart, NearestPlayer
                local Players = game:GetService("Players")
                local LocalPlayer = Players.LocalPlayer
                local MouseModule = require(game:GetService("ReplicatedStorage"):WaitForChild("Mouse"))
                local Skills = {"Z", "C", "V", "F"}
                local ActiveSkills = {}
...
local function StopAimbot()
    AimbotRunning = false  -- Cập nhật trạng thái để dừng vòng lặp aimbot
end

-- Theo dõi trạng thái của toggle Aimbot Skill
spawn(function()
    while task.wait() do
        if _G.Aimbot_Skill and not AimbotRunning then
            StartAimbot()  -- Bật Aimbot khi toggle được bật
        elseif not _G.Aimbot_Skill and AimbotRunning then
            StopAimbot()  -- Dừng Aimbot khi toggle bị tắt
        end
    end
end)
P:AddSeperator("PvP");
...
elseif World3 then
	R:AddButton("Teleport to Lab", function()
		HyperCahaya(CFrame.new(-5017.40869, 314.844055, -2823.0127, -0.925743818, 4.482175e-8, -0.378151238, 4.5550315e-9, 1, 1.0737756e-7, 0.378151238, 9.768162e-8, -0.925743818));
	end);
end
if World2 then
...
if World1 then
	T:AddDropdown("Select Island", {"WindMill","Marine","Middle Town","Jungle","Pirate Village","Desert","Snow Island","MarineFord","Colosseum","Sky Island 1","Sky Island 2","Sky Island 3","Prison","Magma Village","Under Water Island","Fountain City","Shank Room","Mob Island"}, function(value)
		_G.SelectIsland = value;
	end);
end
if World2 then
	T:AddDropdown("Select Island", {"The Cafe","Frist Spot","Dark Area","Flamingo Mansion","Flamingo Room","Green Zone","Factory","Colossuim","Zombie Island","Two Snow Mountain","Punk Hazard","Cursed Ship","Ice Castle","Forgotten Island","Ussop Island","Mini Sky Island"}, function(value)
		_G.SelectIsland = value;
	end);
end
if World3 then
	T:AddDropdown("Select Island", {"Mansion","Port Town","Great Tree","Castle On The Sea","MiniSky","Hydra Island","Floating Turtle","Haunted Castle","Ice Cream Island","Peanut Island","Cake Island","Cocoa Island","Candy Island New","Tiki Outpost"}, function(value)
		_G.SelectIsland = value;
	end);
end
...
if World1 then
	T:AddDropdown("Select NPC", {"Random Devil Fruit","Blox Fruits Dealer","Remove Devil Fruit","Ability Teacher","Dark Step","Electro","Fishman Karate"}, function(value)
		_G.SelectNPC = value;
	end);
end
if World2 then
	T:AddDropdown("Select NPC", {"Dargon Berath","Mtsterious Man","Mysterious Scientist","Awakening Expert","Nerd","Bar Manager","Blox Fruits Dealer","Trevor","Enhancement Editor","Pirate Recruiter","Marines Recruiter","Chemist","Cyborg","Ghoul Mark","Guashiem","El Admin","El Rodolfo","Arowe"}, function(value)
		_G.SelectNPC = value;
	end);
end
if World3 then
	T:AddDropdown("Select NPC", {"Blox Fruits Dealer","Remove Devil Fruit","Horned Man","Hungey Man","Previous Hero","Butler","Lunoven","Trevor","Elite Hunter","Player Hunter","Uzoth"}, function(value)
		_G.SelectNPC = value;
	end);
end
	...
	if (_G.TeleportNPC == true) then
		repeat
			...
			elseif (_G.SelectNPC == "Mtsterious Man") then
				HyperCahaya(CFrame.new(-2574.43335, 1627.92371, -3739.35767, 0.378697902, -9.064003e-9, 0.92552036, -8.95582e-9, 1, 1.3457893e-8, -0.92552036, -1.3385269e-8, 0.378697902));
			elseif (_G.SelectNPC == "Mysterious Scientist") then
				HyperCahaya(CFrame.new(-6437.87793, 250.645355, -4498.92773, 0.502376854, -1.0122363e-8, -0.864648759, 2.3410609e-8, 1, 1.8950865e-9, 0.864648759, -2.1194001e-8, 0.502376854));
			elseif (_G.SelectNPC == "Awakening Expert") then
				HyperCahaya(CFrame.new(-408.098846, 16.0459061, 247.432846, 0.028394036, 6.1759914e-10, 0.999596894, -5.5790594e-9, 1, -4.5937248e-10, -0.999596894, -5.5637677e-9, 0.028394036));
			...
			elseif (_G.SelectNPC == "Blox Fruits Dealer") then
				HyperCahaya(CFrame.new(-450.725464, 73.0458984, 355.636902, -0.780352175, -2.7266168e-8, 0.625340283, 9.785165e-9, 1, 5.581288e-8, -0.625340283, 4.967276e-8, -0.780352175));
			...
			elseif (_G.SelectNPC == "Guashiem") then
				HyperCahaya(CFrame.new(937.953003, 181.083359, 33277.9297, 1, -8.601264e-8, 3.817739e-17, 8.601264e-8, 1, -1.899696e-16, -3.8177373e-17, 1.899696e-16, 1));
			elseif (_G.SelectNPC == "El Admin") then
				HyperCahaya(CFrame.new(1322.80835, 126.345039, 33135.8789, 0.988783717, -8.697976e-8, -0.149354503, 8.622238e-8, 1, -1.1546192e-8, 0.149354503, -1.4610141e-9, 0.988783717));
			elseif (_G.SelectNPC == "El Rodolfo") then
				HyperCahaya(CFrame.new(941.228699, 40.4686775, 32778.9922, -0.818029106, -1.1952438e-8, 0.575176775, -1.2874165e-8, 1, 2.4705387e-9, -0.575176775, -5.383948e-9, -0.818029106));
			elseif (_G.SelectNPC == "Arowe") then
				HyperCahaya(CFrame.new(-1994.51038, 125.519142, -72.2622986, -0.16715166, -6.5541734e-8, -0.985931218, -7.1331556e-8, 1, -5.438366e-8, 0.985931218, 6.1237685e-8, -0.16715166));
			elseif (_G.SelectNPC == "Random Devil Fruit") then
				HyperCahaya(CFrame.new(-1436.19727, 61.8777695, 4.75247526, -0.557794094, 2.7421654e-8, 0.829979479, 5.8327323e-8, 1, 6.1603793e-9, -0.829979479, 5.1846712e-8, -0.557794094));
			elseif (_G.SelectNPC == "Blox Fruits Dealer") then
			...
			elseif (_G.SelectNPC == "Ability Teacher") then
				HyperCahaya(CFrame.new(-1057.67822, 9.65220833, 1799.49146, -0.865874112, -9.2633016e-8, 0.500262439, -7.337594e-8, 1, 5.816689e-8, -0.500262439, 1.3657975e-8, -0.865874112));
...
if World1 then
	T:AddDropdown("Select Island", {"WindMill","Marine","Middle Town","Jungle","Pirate Village","Desert","Snow Island","MarineFord","Colosseum","Sky Island 1","Prison","Magma Village","Under Water Island","Fountain City"}, function(value)
		_G.SelectWarp = value;
	end);
end
if World2 then
	T:AddDropdown("Select Island", {"The Cafe","Frist Spot","Flamingo Room","Green Zone","Zombie Island","Two Snow Mountain","Punk Hazard","Cursed Ship","Ice Castle","Forgotten Island"}, function(value)
		_G.SelectWarp = value;
	end);
end
if World3 then
	T:AddDropdown("Select Island", {"Mansion","Port Town","Great Tree","Castle On The Sea","Hydra Island","Haunted Castle","Ice Cream Island","Peanut Island","Cake Island","Sea to Treats","Sea to Treats New","Tiki Outpost","Secret Tample"}, function(value)
		_G.SelectWarp = value;
	end);
end
...
S:AddButton("Refined Flintlock [ $65,000 Beli ]", function()
	local args = {[1]="BuyItem",[2]="Refined Flintlock"};
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args));
end);
...
S:AddButton("Black Cape [ $50,000 Beli ]", function()
	local args = {[1]="BuyItem",[2]="Black Cape"};
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args));
end);
S:AddButton("Swordsman Hat [ 150k Beli ]", function()
	local args = {[1]="BuyItem",[2]="Swordsman Hat"};
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args));
end);
S:AddButton("Tomoe Ring [ $500k Beli ]", function()
	local args = {[1]="BuyItem",[2]="Tomoe Ring"};
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args));
end);
D:AddSeperator("Sniper");
FruitList = {"Rocket-Rocket","Spike-Spike","Chop-Chop","Spring-Spring","Kilo-Kilo","Spin-Spin","Bird: Falcon","Smoke-Smoke","Flame-Flame","Ice-Ice","Sand-Sand","Dark-Dark","Revive-Revive","Diamond-Diamond","Light-Light","Love-Love","Rubber-Rubber","Barrier-Barrier","Magma-Magma","Door-Door","Quake-Quake","Human-Human: Buddha","String-String","Bird-Bird: Phoenix","Rumble-Rumble","Sound-Sound","Pain-Pain","Gravity-Gravity","Mammoth-Mammoth","Dough-Dough","Venom-Venom","Shadow-Shadow","Control-Control","Soul-Soul","Dragon-Dragon","Leopard-Leopard"};
...
Misc:AddButton("Kaitun Cap", function(value)
	...
	local RaityColor = {Common=Color3.fromRGB(179, 179, 179),Uncommon=Color3.fromRGB(92, 140, 211),Rare=Color3.fromRGB(140, 82, 255),Legendary=Color3.fromRGB(213, 43, 228),Mythical=Color3.fromRGB(238, 47, 50)};
	...
	local ListHuhu = {Superhuman=Vector2.new(3, 2),GodHuman=Vector2.new(3, 2),DeathStep=Vector2.new(4, 3),ElectricClaw=Vector2.new(2, 0),SharkmanKarate=Vector2.new(0, 0),DragonTalon=Vector2.new(1, 5)};
